...
# 邮件内容 - 使用普通字符串，不使用f-string处理大段内容
content = """# 📊 每日记忆更新汇总 - %s
...
### 📝 MEMORY.md 重构更新
- 重新组织分类结构，增加清晰目录导航
- 新增 OpenClaw 操作规范，明确记忆文件更新流程：**先检查差异 → 判断冲突 → 安全合并 → 不随便覆盖**
...
5. **solo** `/Users/matianjun/solo/`
   - 在现有 OpenClaw 配置指南基础上，补充完整对话归档规范
...
msg["From"] = Header(f"OpenClaw 记忆汇总 <{from_addr}>", "utf-8")
msg["To"] = Header(to_addr, "utf-8")
msg["Subject"] = Header(f"{date_str} 记忆更新汇总，请确认", "utf-8")
