...
- **自动提炼邮件发送规则**：发邮件前需要判断**第二天是否是休息日**（参照国家法定节假日日历，包括调休补班的特殊情况）：
  ...
  - 如果第二天是工作日 → 正常发送邮件
- **2026年法定节假日安排（预测，实际以官方为准）**：

| 节假日 | 放假日期 | 星期 | 放假天数 | 调休补班安排 |
|--------|----------|------|----------|--------------|
| 元旦 | 2026-01-01 | 周四 | 1 天 | 无调休 |
| 春节 | 2026-02-17 ~ 2026-02-23 | 初一 ~ 初七 | 7 天 | 补班：2026-02-15（周日）、2026-02-28（周六） |
| 清明节 | 2026-04-04 ~ 2026-04-05 | 周六 ~ 周日 | 2 天 | 无调休（和周末连休） |
| 劳动节 | 2026-05-01 ~ 2026-05-03 | 周四 ~ 周六 | 3 天 | 补班：2026-05-04（周日） |
| 端午节 | 2026-06-25 | 周四 | 1 天 | 无调休 |
| 中秋节 | 2026-09-25 ~ 2026-09-27 | 周五 ~ 周日 | 3 天 | 无调休 |
| 国庆节 | 2026-10-01 ~ 2026-10-07 | 周四 ~ 下周三 | 7 天 | 补班：2026-09-27（周日）、2026-10-10（周六） |

- **判断规则**：
  1. 周六、周日 → 休息日 → 不发送邮件，延后到下一个工作日
  2. 周一到周五 → 工作日 → 正常发送，除非调休补班
  3. 调休补班 → 周末因调休变为工作日 → 正常发送邮件
  4. 本安排为预测，实际以国务院官方发布为准，遇到不确定的情况主动询问确认
...
| 2026-03-24 | feat(calendar): 存入2026年法定节假日预测安排，包括调休补班信息，支持休息日判断 | OpenClaw |
